...
export const metadata: Metadata = {
  title: "Learn — GCSE English Literature Practice",
  description: "Study and practice for GCSE English Literature. Choose your subject and start preparing.",
};
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mb-2 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          GCSE English Literature Study Hub
        </h1>
