...
export const metadata: Metadata = {
  title: "Pricing — Gcse English Literature Premium",
  description: "Unlock unlimited Gcse English Literature practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=gcse-english-literature&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Gcse English Literature Premium
        </h1>
